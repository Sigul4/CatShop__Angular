...
import { loadCards, clearCards, filterCards } from './app-state-store/app.actions';
...
export class AppComponent implements OnInit {
  ...
  onChangeHideless(): void{
    ...
    // if (this.CardPosition !== '-100px') this.CardPosition = '-100px'
    // if (this.CardPosition !== '2vw') this.CardPosition = '2vw'
  }
